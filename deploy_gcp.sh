...
SECRET_KEYS=("EMAIL_PASSWORD" "GEMINI_API_KEY" "TEAMS_WEBHOOK_URL" "EMAIL_SENDER" "ASC_PRIVATE_KEY")

# ── 非敏感變數（一般環境變數）────────────────────
PLAIN_KEYS=("EMAIL_SMTP_SERVER" "EMAIL_SMTP_PORT" "EMAIL_RECIPIENTS" "ASC_KEY_ID" "ASC_ISSUER_ID")
